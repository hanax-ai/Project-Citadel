...
**AG-UI** standardizes how **AI agents connect to front-end applications**
...
Check out the AG-UI GitHub repo to explore live examples, usage patterns, and how to bring AG-UI agents into real applications: [https://github.com/ag-ui-protocol/ag-ui](https://github.com/ag-ui-protocol/ag-ui)
...
For example, a given AI agent may use MCP to call tools (and get context), A2A to communicate with other agents,
and AG-UI to collaborate with a user through a frontend application.
