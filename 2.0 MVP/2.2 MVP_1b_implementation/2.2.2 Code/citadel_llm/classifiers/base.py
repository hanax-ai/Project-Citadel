...
"""
Base classes for content classifiers in the Citadel LLM package.
"""
...
class BaseClassifier(ABC):
    ...
    def __init__(self, logger: Optional[logging.Logger] = None):
        ...
        """
        self.logger = logger or get_logger(f"citadel.llm.classifiers.{self.__class__.__name__.lower()}")
...
class BaseLLMClassifier(BaseClassifier):
    """Base class for content classifiers that use LLMs."""
