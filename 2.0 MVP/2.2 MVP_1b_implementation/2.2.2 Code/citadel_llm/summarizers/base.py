...
"""
Base classes for content summarizers in the Citadel LLM package.
"""
...
class BaseSummarizer(ABC):
    """Base class for all content summarizers."""
    ...
    def __init__(self, logger: Optional[logging.Logger] = None):
        ...
        """
        self.logger = logger or get_logger(f"citadel.llm.summarizers.{self.__class__.__name__.lower()}")
...
class BaseLLMSummarizer(BaseSummarizer):
    """Base class for content summarizers that use LLMs."""
